...
import { defaultMatrix_yzw_gm898_bt_2m } from "./yzw_gm898_bt_2mMatrix";
import { YZW_K68 } from "./yzw_k68";

const commonBrightness = 4
export class YZW_GM898_BT_2M extends YZW_K68 {
    defaultMatrix = defaultMatrix_yzw_gm898_bt_2m
    DAZZLE = 8;
    NORMAL = 10;
