...
import { defaultMatrix_yzw_MilerGM898 } from "./yzw_MilerGM898Matrix"



const commonBrightness = 4
export class YZW_MILERGM898 extends YZW_K68 {
    defaultMatrix = defaultMatrix_yzw_MilerGM898
    DAZZLE = 8;
    NORMAL = 10;
    ...
    setLightSetting = async (lightSet: LightSetting) => {
        ...
        switch (lightSet.type) {
            ...
            case 'LightMusicFollow':
                effect = 0x14
                option = lightSet.option === undefined || lightSet.option === 'upright' ? (0 << 4) | 0 : this.MP[lightSet.option] << 4 | 0
                brightness = 4
                break
