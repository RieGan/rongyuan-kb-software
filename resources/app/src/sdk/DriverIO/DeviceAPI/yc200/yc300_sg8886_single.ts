...
import { defaultMatrix_yc300_sg8886_single } from "./yc300_sg8886_singleMatrix";

export class YC300_SG8886_SINGLE extends YC200Common {
    defaultMatrix = defaultMatrix_yc300_sg8886_single
    DAZZLE = 0
    NORMAL = 0
