...
import { defaultMatrix_yc300_kg006_single } from "./yc300_kg006_singleMatrix";


export class YC300_KG006_SINGLE extends YC200Common {
    defaultMatrix = defaultMatrix_yc300_kg006_single
    DAZZLE = 0
    NORMAL = 0
