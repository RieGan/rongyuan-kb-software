...
import { defaultMatrix_yc200_sg8821_24_2m_single } from "./yc200_sg8821_24_2m_singleMatrix";

export class YC200_SG8821_24_2M_SINGLE extends YC200Common {
    defaultMatrix = defaultMatrix_yc200_sg8821_24_2m_single
    ...
    setLightSetting = async (lightSet: LightSetting) => {
        ...
        switch (lightSet.type) {
            ...
            case 'LightLineWave':
                ...
                speed = lightSet.speed
                brightness = lightSet.value
                option = lightSet.option === 'right' || lightSet.option === undefined ? (0 << 4 | this.DAZZLE) : (1 << 4 | this.DAZZLE)
                break
