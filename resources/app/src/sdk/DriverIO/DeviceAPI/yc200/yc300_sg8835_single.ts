...
import { defaultMatrix_yc300_sg8835_single } from "./yc300_sg8835_singleMatrix";


export class YC300_SG8835_SINGLE extends YC200Common {
    defaultMatrix = defaultMatrix_yc300_sg8835_single
    DAZZLE = 0
    NORMAL = 0
