...
import { defaultMatrix_yc300_k403t_single } from "./yc300_k403t_singleMatrix";
export class YC300_K403T_SINGLE extends YC200Common {
    defaultMatrix = defaultMatrix_yc300_k403t_single
    DAZZLE = 0
    NORMAL = 0
