...
import { defaultMatrix_k68 } from "./k68matrix";
...
export class K68 extends Dk2017 {
    defaultMatrix = defaultMatrix_k68
    getDefault = async () => {
        console.log(await this.getKeyConfig())
    }
...
// export const k68Test = async (addr: number) => {
//     const dev = await DeviceType.findOne({ where: { id: 2 } })
//     if (dev === undefined) throw '数据库里没这个设备'
//     dev.devAddr = addr
//     const k68 = new K68(dev)
//     console.log('open k68', await k68.open())

//     console.log('set report rate ', await k68.setReportRate(1000, 0))
//     console.log('get report rate ', await k68.getReportRate(0))

//     console.log('firmware version', await k68.getFirmwareVersion())
//     console.log('get default matrix :', await k68.getDefault())

//     console.log('get pic', await k68.getLightPic())
// }
