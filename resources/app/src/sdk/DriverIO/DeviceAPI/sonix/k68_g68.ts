...
import { K68 } from "./k68"
import { defaultMatrix_k68_g68 } from "./k68_g68Matrix"
...
export class K68_G68 extends K68 {
    defaultMatrix = defaultMatrix_k68_g68
    ...
    setLightSetting = async (lightSet: LightSetting) => {
        ...
        switch (lightSet.type) {
            ...
            case 'LightWave':
                effect = 0x04
                speed = lightSet.speed
                option = lightSet.option === 'right' ? (0 << 4) | 7 : (1 << 4) | 7
                brightness = lightSet.value
                break
            case 'LightRipple':
                effect = 0x05
            ...
            case 'LightPressAction':
                effect = 0x08
                speed = lightSet.speed
                option = lightSet.option === 'onToOff' ? (0 << 4) | 7 : (1 << 4) | 7
                brightness = lightSet.value
                break
            case 'LightConverage':
                effect = 0x09
