...
import { defaultMatrix_yc500_ck75_single_soc } from "./yc500_ck75_single_socMatrix";

export class YC500_CK75_SINGLE_SOC extends YC500Common {
    defaultMatrix = defaultMatrix_yc500_ck75_single_soc
    DAZZLE = 0
    NORMAL = 0
